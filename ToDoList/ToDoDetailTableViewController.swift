...
//  ToDoList
//
//  Created by Phillip  Tracy on 9/21/21.
//
...
class ToDoDetailTableViewController: UITableViewController {
    ...
    @objc func appActiveNotification(){
        print("The app just came to the forground - cool!")
        ...
        LocalNotificationManager.isAuthorized {(authorized) in
            DispatchQueue.main.async {
                if !authorized && self.reminderSwitch.isOn {
                    self.oneButtonALert(title: "User Has Not Allowed Notification" , message: "To receive alerts for reminders, open the Settings app, select To Do Lits > Notifications > Allow Notifications")
